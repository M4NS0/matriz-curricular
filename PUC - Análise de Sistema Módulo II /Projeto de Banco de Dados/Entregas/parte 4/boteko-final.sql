...
(
    ...
    CONSTRAINT "Fkey-mesa" FOREIGN KEY ("numero-mesa-atual","numero-lugares")
        REFERENCES public."MESA" ("Numero-mesa","Numero-lugares"), 
	
	 CONSTRAINT "Fkey-mesa2" FOREIGN KEY ("numero-mesa-anterior","numero-lugares")
        REFERENCES public."MESA" ("Numero-mesa","Numero-lugares") 
);
/* TABELA ITEM-CARDAPIO-PEDIDO */
...
(	
	...
	CONSTRAINT "Pk-ingrediente-item-pedido" PRIMARY KEY ("Numero-pedido", "Numero-item-cardapio", "Numero-ingrediente"),
	
	CONSTRAINT "Fk-ingrediente-item-cardapio" FOREIGN KEY ("Numero-ingrediente", "Numero-item-cardapio")
        REFERENCES "INGREDIENTE-ITEM-CARDAPIO" ("numero-ingrediente", "numero-item-cardapio"),
	
	CONSTRAINT "Fk-item-cardapio-pedido" FOREIGN KEY ("Numero-item-cardapio", "Numero-pedido")
        REFERENCES public."ITEM-CARDAPIO-PEDIDO" ("Numero-item-cardapio", "Numero-pedido")
);
...
/* TABELA PEDIDO */
	...
	INSERT
    INTO    "PEDIDO"
    VALUES   (1 , '01/03/2020',0.0 ,10001,'Gerente1', 10031, 'Garçom1', null, null , 1,null , 5 ),
            (2 , '02/03/2020',0.0 ,10002,'Gerente2', 10032, 'Garçom2', null, null , 10,null , 5 ),
            (3 , '03/03/2020',0.0 ,10003,'Gerente3', 10033, 'Garçom3', null, null , 2, null ,5 ),
            (4 , '04/03/2020',0.0 ,10004,'Gerente4', 10034, 'Garçom4', null, null , 3, null ,5 ),
            (5 , '05/03/2020',0.0 ,10003,'Gerente3', 10035, 'Garçom5', null, null , 4, null ,5 ),
            (6 , '06/03/2020',0.0 ,10006,'Gerente6', 10036, 'Garçom6', null, null , 6, null ,5 ),
            (7 , '07/03/2020',0.0 ,10007,'Gerente7', 10037, 'Garçom7', null, null , 7, null ,5 ),
            (8 , '08/03/2020',0.0 ,10008,'Gerente8', 10038, 'Garçom8', null, null , 8, null ,2 ),
            (9 , '09/03/2020',0.0 ,10009,'Gerente9', 10039, 'Garçom9', null, null , 11, null ,5 ),
            (10 , '10/03/2020',0.0 ,10010,'Gerente10', 10040, 'Garçom10', null, null , 12, null ,5 ),
            (11 , '11/03/2020',0.0 ,10001,'Gerente1', 10031, 'Garçom1', null, null , 13,null , 2 ),
            (12 , '12/03/2020',0.0 ,10002,'Gerente2', 10032, 'Garçom2', null, null , 14, null ,2 ),
            (13 , '13/03/2020',0.0 ,10003,'Gerente3', 10033, 'Garçom3', null, null , 15, null ,5 ),
            (14 , '14/03/2020',0.0 ,10004,'Gerente4', 10034, 'Garçom4', null, null , 16, null ,5 ),
            (15 , '15/03/2020',0.0 ,10003,'Gerente3', 10035, 'Garçom5', null, null , 17, null ,3 ),
            (16 , '16/03/2020',0.0 ,10006,'Gerente6', 10036, 'Garçom6', null, null , 18, null ,3 ),
            (17 , '16/03/2020',0.0 ,10007,'Gerente7', 10037, 'Garçom7', null, null , 1, null ,5 ),
            (18 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11101, 10101 , null, null , null ),
            (19 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11103, 10102 , null, null , null ),
            (20 , '16/03/2020',0.0 ,10001,'Gerente1', null, null, 11103, 10103 , null, null , null ),
            (21 , '16/03/2020',0.0 ,10001,'Gerente1', null, null, 11107, 10103 , null, null , null ),
            (22 , '16/03/2020',0.0 ,10001,'Gerente1', null, null, 11109, 10107 , null, null , null ),
            (23 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11111, 10109 , null, null , null ),
            (24 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11113, 10111 , null, null , null );
    INSERT
    INTO    "PEDIDO"
    VALUES  (25 , '01/04/2020',0.0 ,10007,'Gerente7', 10037, 'Garçom7', null, null , 1, 3 ,5 ),
            (26 , '05/04/2020',0.0 ,10003,'Gerente3', 10033, 'Garçom3', null, null , 15, 3 ,5 ),
            (27 , '16/03/2020',0.0 ,10001,'Gerente1', null, null, 11107, 10103 , null, null , null ),
            (28 , '16/03/2020',0.0 ,10001,'Gerente1', null, null, 11109, 10107 , null, null , null ),
            (29 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11111, 10109 , null, null , null ),
            (30 , '16/03/2020',0.0 ,10002,'Gerente2', null, null, 11113, 10111 , null, null , null );
...
/* COZINHEIRO */
	...
	UPDATE 	"COZINHEIRO"
	SET 	"Nome-cozinheiro" = 'João Paulo'
	WHERE 	"Nome-cozinheiro" = 'Cozinheiro1';
...
---------------------------------------------------------------------------------------------------
	...
	UPDATE 	"INGREDIENTE"
	SET 	"Descricao" = CONCAT('Peixe')
	WHERE 	"Numero-ingrediente" = 1;

---------------------------------------------------------------------------------------------------
	UPDATE 	"INGREDIENTE"
	SET		"Descricao" = CONCAT("Descricao",' - indisponível')
	WHERE 	"Numero-ingrediente" BETWEEN 2 AND 4;
---------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------
    ...
    WHERE   "numero-mesa-atual" = '1' OR
            "numero-mesa-atual" = '2' OR
            "numero-mesa-atual" = '3' OR
            "numero-mesa-atual" = '4' OR
            "numero-mesa-atual" = '5' OR
            "numero-mesa-atual" = '6' OR
            "numero-mesa-atual" = '7' OR
            "numero-mesa-atual" = '8' OR
            "numero-mesa-atual" = '9' OR
            "numero-mesa-atual" = '10';
